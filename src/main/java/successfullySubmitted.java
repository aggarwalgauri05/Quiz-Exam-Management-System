...
public class successfullySubmitted extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        getContentPane().add(jButton1, new org.netbeans.lib.awtextra.AbsoluteConstraints(1272, 19, -1, -1));

        jLabel1.setFont(new java.awt.Font("Helvetica Neue", 1, 60)); // NOI18N
        jLabel1.setText("Marks Obtained : 10");
        getContentPane().add(jLabel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(434, 244, -1, -1));

        jLabel2.setFont(new java.awt.Font("Helvetica Neue", 1, 60)); // NOI18N
        jLabel2.setText("Successfully Updated!");
        getContentPane().add(jLabel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(408, 360, -1, -1));
